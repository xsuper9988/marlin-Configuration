...
#define HOTEND_OFFSET_X { 0.0, 1133.15 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, -1.25 }  // (mm) relative Y-offset for each nozzle
